...
if __name__ == "__main__":
	...
	data = []
	names = ["wcda","wpda","UCBNet","ThompsonNet","eGreedy"] # ["fixed_dose","wcda","wpda","UCBNet","ThompsonNet","eGreedy"]
	for name in [name2, name3, name7, name8, name9,]: # [name1, name2, name3, name7, name8, name9,]
