...
class WarfarinLoader():
	...
	def get_is_male(self):
		return self.binarize_feature("Gender", {'male': 1, 'female': 0,'na':0.})

	def get_is_female(self):
		return self.binarize_feature("Gender", {'male': 0, 'female': 1,'na':0.})
	...
	def get_diabetes(self):
		return self.binarize_feature("Diabetes", {"na": 0, 1.: 1, 0.: 0})

	def get_valve_replacement(self):
		return self.binarize_feature("Valve Replacement", {"na": 0, 1.: 1, 0.: 0})

	def get_CHF(self):
		return self.binarize_feature("Congestive Heart Failure and/or Cardiomyopathy", {"na": 0, 1.: 1, 0.: 0})

	def get_aspirin(self):
		return self.binarize_feature("Aspirin", {"na": 0, 1.: 1, 0.: 0})

	def get_simvastatin(self):
		return self.binarize_feature("Simvastatin (Zocor)", {"na": 0, 1.: 1, 0.: 0})

	def get_smoker(self):
		return self.binarize_feature("Current Smoker", {"na": 0, 1.: 1, 0.: 0})



	def get_VKORC1_497_GT(self):
		return self.binarize_feature("VKORC1 497 consensus", {"G/T": 1, "T/T": 0, "G/G":0 ,"na": 0})
	def get_VKORC1_497_TT(self):
		return self.binarize_feature("VKORC1 497 consensus", {"G/T": 0, "T/T": 1, "G/G":0 ,"na": 0})
	def get_VKORC1_497_GG(self):
		return self.binarize_feature("VKORC1 497 consensus", {"G/T": 0, "T/T": 0, "G/G":1 ,"na": 0})
	...
	def get_VKORC1_1542_CC(self):
		return self.binarize_feature("VKORC1 1542 consensus", {"C/C": 1, "C/G": 0, "G/G": 0, "na": 0})
	def get_VKORC1_1542_CG(self):
		return self.binarize_feature("VKORC1 1542 consensus", {"C/C": 0, "C/G": 1, "G/G": 0, "na": 0})
	def get_VKORC1_1542_GG(self):
		return self.binarize_feature("VKORC1 1542 consensus", {"C/C": 0, "C/G": 0, "G/G": 1, "na": 0})
	...
	def get_VKORC1_4451_CC(self):
		return self.binarize_feature("VKORC1 -4451 consensus", {"C/C": 1, "A/C": 0, "A/A": 0,"na": 0})
	def get_VKORC1_4451_AC(self):
		return self.binarize_feature("VKORC1 -4451 consensus", {"C/C": 0, "A/C": 1, "A/A": 0,"na": 0})
	def get_VKORC1_4451_AA(self):
		return self.binarize_feature("VKORC1 -4451 consensus", {"C/C": 0, "A/C": 0, "A/A": 1, "na": 0})
	...
	def get_VKORC1_AG(self):
		return self.binarize_feature("VKORC1 -1639 consensus", {"A/G": 1, "A/A": 0, "G/G": 0, "na": 0})

	def get_VKORC1_AA(self):
		return self.binarize_feature("VKORC1 -1639 consensus", {"A/G": 0, "A/A": 1, "G/G": 0, "na": 0})
	...
	def get_CYP2C9_11(self):
		return self.binarize_feature("CYP2C9 consensus", {'*1/*1':1, '*1/*3':0, '*1/*2':0, '*2/*2':0, '*2/*3':0, '*3/*3':0, "na":0, '*1/*5':0, '*1/*13':0, '*1/*14':0, '*1/*11':0, '*1/*6':0})

	def get_CYP2C9_12(self):
		return self.binarize_feature("CYP2C9 consensus", {'*1/*1':0, '*1/*3':0, '*1/*2':1, '*2/*2':0, '*2/*3':0, '*3/*3':0, "na":0, '*1/*5':0, '*1/*13':0, '*1/*14':0, '*1/*11':0, '*1/*6':0})

	def get_CYP2C9_13(self):
		return self.binarize_feature("CYP2C9 consensus", {'*1/*1':0, '*1/*3':1, '*1/*2':0, '*2/*2':0, '*2/*3':0, '*3/*3':0, "na":0, '*1/*5':0, '*1/*13':0, '*1/*14':0, '*1/*11':0, '*1/*6':0})

	def get_CYP2C9_22(self):
		return self.binarize_feature("CYP2C9 consensus", {'*1/*1':0, '*1/*3':0, '*1/*2':0, '*2/*2':1, '*2/*3':0, '*3/*3':0, "na":0, '*1/*5':0, '*1/*13':0, '*1/*14':0, '*1/*11':0, '*1/*6':0})

	def get_CYP2C9_23(self):
		return self.binarize_feature("CYP2C9 consensus", {'*1/*1':0, '*1/*3':0, '*1/*2':0, '*2/*2':0, '*2/*3':1, '*3/*3':0, "na":0, '*1/*5':0, '*1/*13':0, '*1/*14':0, '*1/*11':0, '*1/*6':0})

	def get_CYP2C9_33(self):
		return self.binarize_feature("CYP2C9 consensus", {'*1/*1':0, '*1/*3':0, '*1/*2':0, '*2/*2':0, '*2/*3':0, '*3/*3':1, "na":0, '*1/*5':0, '*1/*13':0, '*1/*14':0, '*1/*11':0, '*1/*6':0})
	...
	def get_amiodarone_status(self):
		return self.binarize_feature("Amiodarone (Cordarone)", {0.:0, 1.:1., "na":0})
